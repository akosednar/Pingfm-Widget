...
<img src="<?php echo $baseurl ?>images/ping.fm-logo.png" id="logo" />
		<form name="theForm" form="" action="processing.php" method="post">
            <input name="i" value="14" type="hidden">
            ...
            <select name="type" id="type">
                ...
                <textarea name="message" cols="40" rows="4" id="message" wrap="VIRTUAL"></textarea><br><br>
		<input id="postbtn" value=" Submit " class="submit bluesubmit" type="submit">
		</form><br><br>
</center>
</div>
</div>
