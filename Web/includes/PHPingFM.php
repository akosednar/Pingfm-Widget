...
class PHPingFM {
  ...
  /**
   * Public API function: user.latest: gets the last messages a
   * user has posted through Ping.fm.
   * 
   * @param $limit
   *   Limit the results returned.  Default is 1 (as of now it was 25 before).
   * @param $order
   ...
   */
  function latest($limit = 1, $order = "DESC") {
