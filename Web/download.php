...
<img src="<?php echo $baseurl ?>images/ping.fm-logo.png" id="logo" />
		<form name="theForm" form="" action="processing.php" method="post">
            <input name="i" value="13" type="hidden">
            <strong>Download Recent:</strong><br>
            <center>
             All your recent posts will be generated into a file for download. <br />
		<input id="postbtn" value=" Submit " type="submit"><br><br>
		</form>
</center>
</div>
</div>
